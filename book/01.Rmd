...
In this section we will be showing you how to set up Git repositories, how to host them on GitHub, and how to copy existing repositories. When running these commands on your own computer make sure to use your own GitHub username and the directory in which you want to set up your repository. The examples on this page are commands used to set up the repository that contains this website (i.e. username: `reroche`, directory: `~/cmu/76270/project4/github-instructions`). This repository is used in most examples throughout the guide.
