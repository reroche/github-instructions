...
(1) **A Unix-like environment:** This guide contains many commands that can be copied directly into Unix-like command lines. MacOS and Linux are both Unix-like environments. A Unix-like environment can be set up in Windows, but that is beyond the scope of these instructions.
