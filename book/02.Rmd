...
You can add files in terminal either individually or all at once.

(1) Adding files individually _(NOTE: If you include multiple files, they must be separated by a space.)_ For example, this command will add `README.md` and `draft.Rmd` to the staging area:
...
There are two different ways of making a commit:
...
Using `git status` gives me a summary of the files we have changed, and further `git add` can move these changes to the staging area to be committed.
