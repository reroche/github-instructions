...
Step 1. Make edits to files in the repository.

Step 2. Add edited files to the staging area.

Step 3. Check which files have been staged/unstaged.

Step 4. Save these changes in a commit.
...
Here are a few ways to use the `git add` command: (1) Adding new or modified files individually, (2) Adding all tracked and untracked files in the working directory, (3) Adding all tracked and untracked files (new, modified, and deleted).
